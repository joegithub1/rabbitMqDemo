...
public class Recv1 {
	...
	public static void main(String[] args) throws IOException, TimeoutException {
		...
		//声明队列
		channel.queueDeclare(QueueNameUtils.EX_QUEUE_NAME_T1, false, false, false, null);
		//声明路由器及类型
		channel.exchangeDeclare(QueueNameUtils.EX_LOG, BuiltinExchangeType.FANOUT);
		 //绑定队列到路由器上
		channel.queueBind(QueueNameUtils.EX_QUEUE_NAME_T1, QueueNameUtils.EX_LOG, "");
		...
		channel.basicConsume(QueueNameUtils.EX_QUEUE_NAME_T1, true,consumer);
	}
}
